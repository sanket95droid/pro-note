        ...
        <div className="h-screen overflow-hidden">
            ...
            <div className="absolute flex justify-center items-center -translate-y-1/2 max-[950px]:-translate-y-[20%] -translate-x-1/2 left-1/2 top-1/2">
                <div className="grid max-[950px]:grid-cols-1 max-[1200px]:gap-32 max-[950px]:gap-8 grid-cols-3 gap-8">
                    <div className="hover:scale-110 p-8 border text-center justify-self-center duration-200 backdrop-filter backdrop-blur-md bg-opacity-0 bg-white/0 border-gray-100/15 outline-none shadow-xl rounded-xl">
                        <h2 className="text-4xl text-red-400 drop-shadow-glow font-bold line-through">$7</h2>
