...
const Navbar = () => {
  const {userId} = auth()
  return (
<nav className="bg-transparent backdrop-blur-sm z-10 border-b-[#121212] border-b-[1px] mx-4 mt-4 top-0 sm:top-0 sticky">
  ...
  <div className="flex justify-between">
      ...
      {!userId ? 
      <div className="flex absolute right-4 top-0 items-center space-x-1 font-semibold">
        <Link href="/sign-in">
